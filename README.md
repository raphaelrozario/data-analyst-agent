# 📊 Data Analyst Agent — AI-Powered SQL + Insight Generator
...
- 🏗 Execute them on DuckDB  
- 📊 Return analytical results  
- 🖼 Produce visualizations  
- 🧹 Clean / preprocess data  
- 🧠 Reason across multiple tables  

This showcases real-world **Agentic AI**, tool calling, SQL generation, and data intelligence — ideal for LLM engineering roles.
...
### ✔️ Natural Language → SQL → Answers
Ask questions like:
- *“Show me total revenue per product.”*  
- *“Join sales_data and customers_data to show each customer’s spending.”*  
...
## 🔑 API Key Screen and Uploading a Dataset
